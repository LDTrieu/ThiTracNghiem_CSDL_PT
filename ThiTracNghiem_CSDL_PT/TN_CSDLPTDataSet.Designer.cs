...
namespace ThiTracNghiem_CSDL_PT.TN_CSDLPTDataSetTableAdapters {
...
SELECT MASV, MAMH, LAN, NGAYTHI, DIEM, BAITHI FROM BANGDIEM WHERE (LAN = @LAN) AND (MAMH = @MAMH) AND (MASV = @MASV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ThiTracNghiem_CSDL_PT.Properties.Settings.Default.TN_CSDLPTConnectionString;
        }
